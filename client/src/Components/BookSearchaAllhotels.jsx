...
const BookSearchaAllhotels = ({hotel}) => {
  return (
    <div
              key={hotel._id}
              className="flex flex-col text-center  lg:flex-row lg:text-left gap-4 py-4 border border-gray-300 bg-slate-200 mx-3 dark"
            >
...
export default BookSearchaAllhotels